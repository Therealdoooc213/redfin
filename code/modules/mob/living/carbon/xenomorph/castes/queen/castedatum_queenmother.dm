/datum/xeno_caste/queen/mother
	caste_name = "Queen Mother"
	display_name = "Queen Mother"
	upgrade_name = ""
	base_strain_type = /mob/living/carbon/xenomorph/queen/mother
	caste_type_path = /mob/living/carbon/xenomorph/queen/mother
	caste_desc = "The biggest and baddest xeno. The Queen Mother controls all of the hives."
	...
	// *** Melee Attacks *** //
	melee_damage = 35
	exosuit_slash_damage_multiplier = 3
	attack_delay = 9
...
*/
	caste_flags = CASTE_IS_INTELLIGENT|CASTE_IS_BUILDER|CASTE_STAGGER_RESISTANT|CASTE_LEADER_TYPE|CASTE_INSTANT_EVOLUTION|CASTE_MUTATIONS_ALLOWED|CASTE_EVOLUTION_ALLOWED
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 75, BULLET = 75, LASER = 75, ENERGY = 75, BOMB = 80, BIO = 75, FIRE = 80, ACID = 60)
...
/datum/xeno_caste/queen/young/mother
	upgrade = XENO_UPGRADE_NORMAL

/datum/xeno_caste/queen/primordial/mother
